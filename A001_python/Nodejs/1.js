...
/**
 * paramJson对象定义
 * 用于存储特定参数的json对象，包含平台标识、特殊属性字符串和SKU标记字符串
 */
paramJson = {
  "platform2": "100000000001", // 平台标识，此处为示例值
  "specialAttrStr": "p0ppppppppp5pppppppppppppppp", // 特殊属性字符串，示例值
  "skuMarkStr": "00" // SKU标记字符串，示例值
}
body = {
  // SKU的唯一标识符
  "skuId": 100015248503,
